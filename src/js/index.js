...
listaSelecaoPokedevs.forEach(pokedev =>{
    ...
    //PASSO 4 - ao clicar em um pokedev da listagem pegamos o id desse pokedev pra saber qual 
     const idpPokedevSelecionado = pokedev.attributes.id.value;
     const idDoCartaoPokedevParaAbrir = "cartao-" + idpPokedevSelecionado;
     ...
     //PASSO 6 - adicinar a classe ativo no pokedev selecionado na listagem
     const PokedevSelecionadoNaListagem = document.getElementById(idpPokedevSelecionado);
     idpPokedevSelecionadoNaListagem.classList.add("ativo");
